...
export const en_GB: KitOfTranslatedWords = {
    ...
    theFieldSize_btnResultInfo: `Field settings have been saved`,
    ...
    theServiceWorkerMessage_appSavedForOffline: `The Minesweeper game can work without the Internet!`,
    theServiceWorkerMessage_appSuccessfullyInstalled: `The Minesweeper game has been successfully installed!`,
